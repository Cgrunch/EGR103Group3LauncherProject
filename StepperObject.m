classdef StepperObject
    %   Stepper class
    %   This runs an Adafruit unipolar stepper motor from Matlab
    %   I do not know if it will actually work but based on my testing
    %   flasing LED's, it is close!
    ...
    methods
        ...
        function obj = StepperObject(ArduinoObject, StepsPerRev, MotorPin1, MotorPin2, MotorPin3, MotorPin4)
        ...
        function MoveClockWise(obj, MotorSpeed, StepsToMove)
            ...
            if 0 == MotorSpeed
                obj.motorSpeed  = 1; %default to 1 RPM
            else
